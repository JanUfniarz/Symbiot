    ...
    def gpt(self, template: str):
        templates = dict(
            ...
            one_value_generator=dict(init_messages=[self._sys_prompt("""
                You are a one value generator and your role is to generate 
                only one value. in next message you will be given instruction 
                what to generate. Be sure to provide only this. 
